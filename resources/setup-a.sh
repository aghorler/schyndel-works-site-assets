...
wget -P /etc/apache2/schyndel/server_root/conf/ https://aaronhorler.com/httpd-a.conf
mv /etc/apache2/schyndel/server_root/conf/httpd-a.conf /etc/apache2/schyndel/server_root/conf/httpd.conf
